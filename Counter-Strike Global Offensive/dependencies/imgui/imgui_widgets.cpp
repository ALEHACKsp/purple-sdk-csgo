...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    {
        int bordersize = ImGui::GetStyle().FrameBorderSize;
        window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x - bordersize, check_bb.Min.y - bordersize), ImVec2(check_bb.Max.x - bordersize, check_bb.Max.y - bordersize), check_col, style.FrameRounding);
    }
